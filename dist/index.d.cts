export { Locale, getBattleItemName, getHeldItemName, getMapDescription, getMapName, getMoveName, getNeutralName, getPokemonName, getSpawnInfo, getSpawnInfoForSpawn, moveNameToKey } from './i18n/index.cjs';
